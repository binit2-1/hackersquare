...
type LandingClientProps = {
  ...
  initialRecommendations: HackathonProps[];
...
const LandingClient = ({
  ...
  const fetchRecommendations = async () => {
    if (initialRecommendations.length > 0 || initialRecommendationsError) {
      if (initialRecommendationsError) {
        throw new Error(initialRecommendationsError);
      }
